				...
				<div class="col-md-6 col-lg-4 item">
					...
					<div class="author">
						<img class="rounded-circle"
							src="resources/aboutPageResources/img/1.jpg">
					...
					<div class="col-md-6 col-lg-4 item">
						...
						<div class="author">
							<img class="rounded-circle"
							src="resources/aboutPageResources/img/3.jpg">
						...
						<div class="col-md-6 col-lg-4 item">
							...
							<div class="author">
								<img class="rounded-circle"
							src="resources/aboutPageResources/img/2.jpg">
